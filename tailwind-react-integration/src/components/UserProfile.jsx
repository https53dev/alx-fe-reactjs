...
const UserProfile = () => {
  return (
    <div className="bg-gray-100 my-10 sm:my-12 md:my-16 lg:my-20 rounded-lg shadow-lg container mx-auto p-4 sm:p-4 md:p-8 max-w-xs sm:max-w-sm md:max-w-sm lg:max-w-lg">
